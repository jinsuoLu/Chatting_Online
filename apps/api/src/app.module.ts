...
@Module({ imports:[HealthModule,RedisModule,AuditModule,SchedulerModule,RoomsModule,QuotasModule,AccessLinksModule,VisitorAuthModule], controllers:[VisitorsController,MessagesController], providers:[Logger,PrismaService,VisitorsService,MessagesService,RealtimeGateway] }) export class AppModule {}
